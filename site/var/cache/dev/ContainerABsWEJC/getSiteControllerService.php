...
$this->services['App\Controller\SiteController'] = $instance = new \App\Controller\SiteController(($this->services['swiftmailer.mailer.default'] ?? $this->load('getSwiftmailer_Mailer_DefaultService.php')));
