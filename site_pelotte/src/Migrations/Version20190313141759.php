 ...
 */
final class Version20190313141759 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE contacter CHANGE nom noms VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE contacter CHANGE noms nom VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci');
