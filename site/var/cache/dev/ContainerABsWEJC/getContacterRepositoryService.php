...
// Returns the private 'App\Repository\ContacterRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\ContacterRepository.php';

return $this->privates['App\Repository\ContacterRepository'] = new \App\Repository\ContacterRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
